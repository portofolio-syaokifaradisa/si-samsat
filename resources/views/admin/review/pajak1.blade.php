...
<section class="section">
    <div class="section-header">
      <h1>Pengajuan Perpanjangan 1 Tahun</h1>
    </div>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h4>Pengajuan Perpanjangan 1 Tahun</h4>
            </div>
            <div class="card-body p-0">
              <div class="table-responsive px-4 pb-4 mt-3">
                ...
                <table class="table table-bordered" id="pajak1-datatables-report">
                  <thead>
                    <tr>
...
@section('js-extends')
  <script type="text/javascript">
    $(function () {
        $('#pajak1-datatables-report tfoot th').each(function () {
        ...
        $('#pajak1-datatables-report').DataTable({
            processing: true,
            serverSide: true,
            autoWidth: true,
            dom: 'Brtip',
            ajax: "{{ route('admin.report.pajak1.index') }}",
            columns: [
        ...
        $('#btn-report').click(function(){
          ...
          location.href = `http://si-samsat.test/admin/report/pajak1/download?order_number=${order_number}&name=${name}&date=${date}&price=${price}&status=${status}`
        });
    });
  </script>
@endsection