          ...
          <div class="card">
            ...
            <div class="card-body p-0">
              <div class="table-responsive px-4 pb-4 mt-3">
                ...
                <table class="table table-bordered" id="duplikat-datatables-report">
                  <thead>
                    <tr>
...
@section('js-extends')
  <script type="text/javascript">
    $(function () {
        $('#duplikat-datatables-report tfoot th').each(function () {
        ...
        $('#duplikat-datatables-report').DataTable({
            processing: true,
            serverSide: true,
            autoWidth: true,
            dom: 'Brtip',
            ajax: "{{ route('admin.report.duplikat.index') }}",
            columns: [
        ...
        $('#btn-report').click(function(){
          ...
          location.href = `http://si-samsat.test/admin/report/duplikat/download?order_number=${order_number}&name=${name}&date=${date}&price=${price}&status=${status}&machine_number=${machine_number}&chassis_number=${chassis_number}`
        });
    });
  </script>
@endsection