          ...
          <div class="card">
            ...
            <div class="card-body p-0">
              <div class="table-responsive px-4 pb-4 mt-3">
                ...
                <table class="table table-bordered" id="mutasi-out-datatables-report">
                  <thead>
                    <tr>
                  ...
                  <tfoot>
                      <th id="order-number" class="text-center">Nomor Order</th>
                      <th id="machine-number" class="text-center">Nomor<br>Mesin</th>
                      <th id="chassis-number" class="text-center">Nomor<br>Rangka</th>
...
@section('js-extends')
  <script type="text/javascript">
    $(function () {
        $('#mutasi-out-datatables-report tfoot th').each(function () {
        ...
        $('#mutasi-out-datatables-report').DataTable({
            processing: true,
            serverSide: true,
            autoWidth: true,
            dom: 'Brtip',
            ajax: "{{ route('admin.report.mutasi-out.index') }}",
            columns: [
        ...
        $('#btn-report').click(function(){
          ...
          location.href = `http://si-samsat.test/admin/report/mutasi-out/download?order_number=${order_number}&name=${name}&date=${date}&price=${price}&status=${status}&machine_number=${machine_number}&chassis_number=${chassis_number}`
        });
    });
  </script>
@endsection