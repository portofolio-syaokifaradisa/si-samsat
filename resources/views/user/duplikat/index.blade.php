          ...
          <div class="card">
            <div class="card-header">
              ...
              <div class="card-header-form">
                <a href="{{ route('duplikat.create') }}" class="btn btn-primary">
                  Ajukan Duplikat
                </a>
              </div>
            </div>
                            ...
                            <div class="btn-group dropright px-0 pr-2">
                              ...
                              <div class="dropdown-menu dropright">
                                @if($data->status == "TERKIRIM")
                                  <a class="dropdown-item has-icon" href="{{ route('duplikat.edit', ['id' => $data->id]) }}">
                                    <i class="fas fa-edit"></i>
                                    Edit
                                  </a>
                                  <form action="{{ route('duplikat.cancel', ['id' => $data->id]) }}" method="POST" id="delete-form-{{ $index }}">
                                    @csrf
                                    @method('PUT')
                                ...
                                @elseif ($data->status == "DITERIMA" || $data->status == "SELESAI")
                                  <a class="dropdown-item has-icon" href="{{ route('duplikat.print', ['id' => $data->id]) }}" target="_blank">
