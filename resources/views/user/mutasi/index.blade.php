          ...
          <div class="card">
            <div class="card-header">
              ...
              <div class="card-header-form">
                <a href="{{ route('mutasi.create', ['type' => $type]) }}" class="btn btn-primary">
                  Ajukan Mutasi
                </a>
              </div>
            </div>
                            ...
                            <div class="btn-group dropright px-0 pr-2">
                              ...
                              <div class="dropdown-menu dropright">
                                @if($data->status == "TERKIRIM")
                                  <a class="dropdown-item has-icon" href="{{ route('mutasi.edit', ['id' => $data->id, 'type' => $type]) }}">
                                    <i class="fas fa-edit"></i>
                                    Edit
                                  </a>
                                  <form action="{{ route('mutasi.cancel', ['id' => $data->id, 'type' => $type]) }}" method="POST" id="delete-form-{{ $index }}">
                                    @csrf
                                    @method('PUT')
                                ...
                                @elseif ($data->status == "DITERIMA" || $data->status == "SELESAI")
                                  <a class="dropdown-item has-icon" href="{{ route('mutasi.print', ['id' => $data->id, 'type' => $type]) }}" target="_blank">
